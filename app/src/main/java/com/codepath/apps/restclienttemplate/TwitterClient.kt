...
class TwitterClient(context: Context) : OAuthBaseClient(
    ...
    companion object {
        val REST_API_INSTANCE = TwitterApi.instance() // Changed to TwitterApi

        const val REST_URL = "https://api.twitter.com/1.1" // Changed to Twitter home URL, base API URL
    ...
    // CHANGED the function name and path for api DEFINE METHODS for different API endpoints here
